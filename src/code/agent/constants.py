...
# FC OpenAPI（StopAsyncTask / GetAsyncTask / ListAsyncTasks）配置
...
# GPU 侧函数名，用于 FC OpenAPI 调用；未配置时从 FC_FUNCTION_NAME 去除 -gw 后缀推导
GPU_FUNCTION_NAME = os.getenv("GPU_FUNCTION_NAME", "")
