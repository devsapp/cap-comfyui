"""Provision trusted v0.27 workflow-template inputs into the active tenant directory.

The v0.27.0 workflow-template package ships workflow JSON and previews, but not
