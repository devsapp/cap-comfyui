...
_PATCH_MARKER = "_funart_v0331_template_assets_patch_installed"
...
def _ensure_trusted_input(folder_paths, path: str) -> None:
    try:
        ...
        print(f"[FunArt-v0.33.1-Template-Assets] Provisioning failed: {exc}")
...
def install_template_asset_patch() -> bool:
    ...
    print("[FunArt-v0.33.1-Template-Assets] ✅ Tenant-aware template inputs enabled")
    return True
